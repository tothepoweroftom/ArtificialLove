...
//    let chars = ["\\xa6", "\\x80", "\n", "\\x93", "\\x94", "\\x99", "\\x98", "\\x9d", "\\x9c", "!", " ", "\"", "%", "$", "'", "&", "\\xa9", "(", "-", ",", "/", ".", "1", "0", "3", "2", "5", "4", "7", "6", "9", "8", ";", ":", "=", "?", "@", "\\xc3", ")", "\\xe2", "[", "]", "_", "a", "c", "b", "e", "d", "g", "f", "i", "h", "k", "j", "m", "l", "o", "n", "q", "p", "s", "r", "u", "t", "w", "v", "y", "x", "z"]
//    let chars = [String]()
    ...
    init(pathToTrainedWeights: String, chars: [String]) {
        self.pathToTrainedWeights = pathToTrainedWeights
        self.chars = chars
        inputSize = self.chars.count
    }
